...
const SLOT_LABEL: Record<string, string> = {
  ...
  dissect_methodology: '拆书·写法手册',
  dissect_structure: '拆书·结构统计',
  dissect_bridges: '拆书·桥段库',
  dissect_character_archive: '拆书·人物功能谱',
  dissect_synopsis: '拆书·全书骨架',
  dissect_corpus: '拆书·拆书卡',
  dissect_style: '拆书·文风指纹',
  system_role: '系统角色',
